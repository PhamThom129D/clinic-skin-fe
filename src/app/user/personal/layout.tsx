...
  return (
    <>
        ...
        >
            {isDark && (<Box sx={{ position: "absolute", inset: 0, backgroundColor: "rgba(40, 99, 57, 0.5)", pointerEvents: "none", }} />)}
            <Header />
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, maxWidth: '1400px', mx: 'auto', my: 7, gap: 3}}>
